...
async function runUpdate() {
    ...
    const tasks = selected.map(function (item) {
        ...
        const cacheExpired = Boolean(cfg.cacheDiffMode > 0 && !forceRefresh && cachedPrevious &&
        ...
        const cacheMatched = Boolean(cfg.cacheDiffMode > 0 && !forceRefresh && publicInfo.ip &&
            cachedPrevious && !cacheExpired && (cfg.cacheDiffMode === 1
...
function buildConfig(args) {
    ...
    return {
        ...
        cacheDiffMode: parseCacheDiffMode(args.cache_diff),
